...
def create_xai_report(
    ...
    <head>
        ...
        <style>
            ...
            .training-summary pre {{ background-color: #f4f4f4; padding: 1em; border: 1px solid #ddd; margin: 1em 0; font-family: monospace; white-space: pre-wrap; word-wrap: break-word; overflow-wrap: anywhere; max-width: 100%; }}
...
def main():
    ...
    # Prefer 'materialized_dir' to match this project's dataset conventions
    cfg_for_dataset = {"materialized_dir": dataset_dir, **cfg}
