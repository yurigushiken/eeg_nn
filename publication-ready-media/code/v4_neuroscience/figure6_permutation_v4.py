"""
Figure 6: Permutation Testing (v4 - Fixed Occlusion)
...
from pub_style_v4 import COLORS, WONG_COLORS, save_publication_figure, add_panel_label, increase_bottom_margin
...
def create_v4_permutation():
    """Create v4 permutation figure with occlusion fixes"""
    ...
    # v4 FIX: Stats box with increased padding
    ...
    # v4 FIX: Null statistics BELOW legend area
    ...
    # v4 FIX: Legend with alpha for better contrast
...
if __name__ == '__main__':
    ...
    print("\n" + "="*70)
    print("GENERATING FIGURE 6 v4: PERMUTATION (FIXED OCCLUSION)")
    print("="*70)
    print("v4 Fixes:")
    ...
    fig = create_v4_permutation()
    save_publication_figure(fig, output_dir / 'figure6_permutation_v4',
                           formats=['pdf', 'png', 'svg'])
    
    plt.close()
    print("\n[OK] Figure 6 v4 complete!")
    print("="*70)
