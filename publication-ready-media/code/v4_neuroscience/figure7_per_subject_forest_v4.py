"""
Figure 7: Per-Subject Performance Forest Plot (v4 - PI Feedback Implemented)
...
if __name__ == '__main__':
    ...
    print("\n" + "="*70)
    print("GENERATING FIGURE 7 v4: PER-SUBJECT FOREST (PI FEEDBACK)")
    print("="*70)
    print("Improvements:")
    ...
    save_publication_figure(fig, output_dir / 'figure7_per_subject_forest_v4',
                           formats=['pdf', 'png', 'svg'])
    
    plt.close()
    print("\n[OK] Figure 7 v4 complete - PI feedback implemented!")
    print("="*70)
